...
\input{./parts/Versionstabelle}

\input{./parts/Danksagung}

\tableofcontents
\input{./parts/Vorwort}
\part{Schaltnetze}
\input{./parts/Schaltnetze/Schaltnetze_Einfuehrung}
\input{./parts/Schaltnetze/Schaltnetzrealisierung}
\input{./parts/Schaltnetze/Laufzeitverhalten}
\part{Schaltwerke}
\input{./parts/Schaltwerke/FlipFlops}
\input{./parts/Schaltwerke/EndlicheAutomaten}
\input{./parts/Schaltwerke/Schaltwerksynthese}
\input{./parts/Schaltwerke/AusgewaehlteSchaltwerke}
\input{./parts/Schaltwerke/RegisterTransferEntwurf}
